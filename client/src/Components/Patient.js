...
class Patient extends Component {
    ...
    render() {
        let { name, DOB,  doctor_list, doctorConsultation,  contact_info } = this.state;
        ...
        return (
            <div className='container' >
                ...
                <div className='row mt-3' style={{paddingTop:'25px'}}>
                    <div className='col-6 mt-2' style={{height: "310px",overflow:'scroll',border: '1px solid black'}}>
                        <Collapse>
                    ...
                    <div className='col-6 mt-2' style={{height: "310px", overflow:'auto',border: '1px solid black'}}>
